...
//helper function to create input checkbox with event listener for if a book is read
...
function fillOutEditForm(book) {
  ...
  document.querySelector(".form-add-button").textContent = "Book";
